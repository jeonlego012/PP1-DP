...
public class MainTest {
	...
	public void testMain() {
		...
		String[] args = {"/Users/youngone/ppbd3/PP1-DP", "data/PP1-DP.arff"}; // for mac users
	...
	public void testForTasks2() {
		...
		String[] args = {"/Users/youngone/PP1test/Java", "data/PP1test.arff"};
		assertEquals(args.length, 2);
		Main.main(args);
	}
	@Test
	public void testForTask22() {
		String[] args = {"/Users/youngone/ppbd3/java", "data/PP1test2.arff"};
		assertEquals(args.length, 2);
		Main.main(args);
	}
}